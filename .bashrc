...
export HISTTIMEFORMAT='%F %T ' # historyへの時間出力
export HISTCONTROL=ignoredups:erasedups # historyに重複したコマンドを記録しない
export HISTSIZE=100000                  # 現在のセッションで利用しているhistoryの履歴数を定義する
...
# display branch name in git project.
